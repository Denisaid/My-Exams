...
describe("Repository test", function () {
    describe("instantiation", function () {
        ...
        it('Should add data property on init', () => {
    ...
    describe('add', () => {
        ...
        it('Missing property from the entity', () => {
            const instance = new Repository({ name: "string", age: "number", birthday: "object" });
    ...
    describe('getId', () => {
        it('Returns the entity with given id', () => {
            ...
            instance.add({ name: "Pesho", age: 22, birthday: new Date(1998, 0, 7) });
            instance.add({ name: "Test1", age: 22, birthday: new Date(1998, 0, 7) });
            expect(instance.getId(1)).to.deep.equal({ name: "Test1", age: 22, birthday: new Date(1998, 0, 7) });
        });
    ...
    describe('del', () => {
        it('Deleted all entity by given id', () => {
            const instance = new Repository({ name: "string", age: "number", birthday: "object" });
            instance.add({ name: "Pesho", age: 22, birthday: new Date(1998, 0, 7) });
            instance.add({ name: "Test1", age: 22, birthday: new Date(1998, 0, 7) });
            instance.del(1);
